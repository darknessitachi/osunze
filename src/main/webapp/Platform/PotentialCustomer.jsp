...
<script language="javascript">
	$(document).ready(function() {
		...
		$('#gridTable').datagrid({
			...
			url : '${ctx}/potentialCustomer/queryList.do',
			...
			columns : [[
			    {title : '<z:lang id="Customer.name"/>',field : 'name',width : 30},
			    {title : '<z:lang id="Common.Sex"/>',field : 'sex',width : 20}, 
			    {title : '<z:lang id="Common.Mobile"/>',field : 'mobile',width : 20},
			    {title : '<z:lang id="Customer.comefrom"/>',field : 'comeFrom',width : 20},
			    {title : '<z:lang id="Customer.visitDate"/>',field : 'visitDate',width : 20},
			    {title : '<z:lang id="Common.Address"/>',field : 'address',width : 30},
			    {title : '<z:lang id="Common.Description"/>',field : 'description',width : 30}
			]]
		});
	...
	function edit() {
		...
		diag.width = 420;
		diag.height = 360;
		diag.title = "<z:lang id='Customer.update'/>";
		diag.url = "${ctx}/potentialCustomer/editUI.do?id="+ids;
	...
	function add() {
		...
		diag.width = 420;
		diag.height = 360;
		diag.title = "<z:lang id='Customer.add'/>";
		diag.url = "${ctx}/potentialCustomer/editUI.do";
		diag.onLoad = function() {
		};
		diag.onOk = doSave;
		diag.show();
	...
	function doSave() {
		...
		Server.sendRequest("potentialCustomer/save.do", dc, function(response) {
